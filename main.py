...
async def on_ready():
    ...
    for guild in bot.guilds:
        ...
        async def daily(interaction: discord.Interaction):
            await interaction.response.send_message(await server.daily(interaction.user, interaction.guild))
        ...
        async def members(interaction: discord.Interaction):
            await interaction.response.send_message(await server.members(interaction.guild))
        ...
        async def next_rank(interaction: discord.Interaction):
            await interaction.response.send_message(await server.next_rank(interaction.user, interaction.guild))
        ...
        async def richest(interaction: discord.Interaction):
             await interaction.response.send_message(await server.richest(interaction.guild))
        ...
        async def whoami(interaction: discord.Interaction):
             await interaction.response.send_message(await server.whoami(interaction.user))
        ...
        async def work(interaction: discord.Interaction):
            await interaction.response.send_message(await server.work(interaction.user))
        ...
        async def add_rank_up_role(
            ...
            """
            await interaction.response.send_message(await server.add_rank_up_role(
                interaction.guild,
                rank,
                to_add,
                to_remove
        ...
        async def set_bot_channel(interaction : discord.Interaction, channel : discord.TextChannel):
            ...
            """
            await interaction.response.send_message(await server.set_bot_channel(interaction.guild, channel))
        ...
        async def set_daily_limits(interaction : discord.Interaction, daily_min : int = -1, daily_max : int = -1):
            ...
            """
            await interaction.response.send_message(await server.set_daily_limits(interaction.guild, daily_min, daily_max))
        ...
        async def set_pay_limits(interaction : discord.Interaction, min_pay : int = -1, max_pay : int = -1):
            ...
            """
            await interaction.response.send_message(await server.set_pay_limits(interaction.guild, min_pay, max_pay))
        ...
        async def remove_rank_up_role(
            ...
            remove_from_remove : List[discord.Role]
                A list of roles to remove when the assigned rank is reached
            """
            await interaction.response.send_message(await server.remove_rank_up_role(
                interaction.guild,
                rank,
                remove_from_add,
                remove_from_remove
